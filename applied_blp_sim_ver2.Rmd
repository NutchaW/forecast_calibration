...
# BMC/EW-BMC --------------------------------------------------------------------------
# not including EW-BMC in the function currently since we have yet to make this converge
# Just try with BMC2 for now
for(mix_ens in forecast_names[5]){
  ...
  hyperpars <- list(alpha_w=rep(1.0,K),alpha_omega=rep(1.0,M),omega_ew=rep(1/M,M))
