...
params_list <- list(BLP_params, EW_BLP_params, TLP_params,
                    BM2_params, BM3_params, BM4_params,BM5_params,
                    EW_BM2_params, EW_BM3_params, EW_BM4_params, EW_BM5_params)
save(params_list, file="./Renvir/run5.RData")
```
...
for (i in 1:5){
  assign(paste0("params_run_",i),
         loadRData(paste0("./Renvir/run",i,".Rdata")))
}
